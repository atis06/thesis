...
A \ref{fig:train-acc-epoch}-es ábrán látható, hogy a normált bemenetű modellek eleve magasabb tanítási pontossággal kezdtek, továbbá a modell méretének növelésével a konvergálás is hatékonyabbá vált. %Valószínűsíthető, hogy a 4096 méretű modell további tanítást követően jobb teljesítménnyel oldaná meg a maszkolási feladatot.
...
A \ref{fig:train-loss-epoch}-es ábra alapján elmondható, hogy normált bemenet esetén kisebb loss értékről indult a tanítás és a nagyméretű modellnek sikerült elérni a 7 alatti értéket is. %A normált bemenetű modellek görbéi alapján érdemes lehet kisebb \textit{learning rate}-ekkel próbálkozni.
