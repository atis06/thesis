...
tanítási részletek 2 modell - halmaz vágása 
...
tanított modell tök jó dolog -> mentett súlyok

fej nélküli háló, súlyok inicializálása

hatékony használat, gyors, nem igényel komoly erőforrást, helytakarékos, egyszerű a használata

mentett súlyok betöltése, súlyok fagyasztása, fej nélküli használat

bemenet, a szokásos eljárások -> BiLSTM max pooling utáni kimenete

micsoda sok dologra fel lehet használni a vektorokat
